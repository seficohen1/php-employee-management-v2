const getEmployeeJSON = async () => {
  const url = "http://localhost:8080/php-employee-management-v1/dashboard/get";
  try {
...
$("#wrapper").jsGrid({
  ...
  controller: {
    ...
    loadData: function () {
      let d = $.Deferred();
      return $.ajax({
        url: "http://localhost:8080/php-employee-management-v1/dashboard/get",
        type: "GET",
        dataType: "json",
    ...
    insertItem: async function (item) {
      ...
      return $.ajax({
        type: "POST",
        url: "http://localhost:8080/php-employee-management-v1/employee/addNewEmployee",
        data: item,
        success: function (data) {
          console.log(item)
          return d.resolve(data);
    ...
    updateItem: function (item) {
      var d = $.Deferred();
      console.log(item, 'coming from here');
      return $.ajax({
        type: "PUT",
    ...
    deleteItem: function (item) {
      ...
      return $.ajax({
        type: "POST",
        url: "http://localhost:8080/php-employee-management-v1/employee/deleteEmployee",
        data: item, 
      }).done(function (res) {
  ...
  rowClick: function (employeeId) {
    location.href = "http://localhost:8080/php-employee-management-v1/employee/getEmpById/" + employeeId.item.id;
  },
  /* Redirects to the employee page with the employee's data. */
